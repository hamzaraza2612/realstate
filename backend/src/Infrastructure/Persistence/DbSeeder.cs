...
public static class DbSeeder
{
    private static readonly Dictionary<string, string[]> SystemRolePermissions = new()
    {
        ...
        ["Finance Manager"] = new[] { Permissions.Finance.InvoiceCreate, Permissions.Finance.PaymentApprove, Permissions.Finance.ReportsView, Permissions.Finance.Manage, Permissions.Sales.PaymentRecord, Permissions.AuditLogs.View, Permissions.Reports.View },
        ...
        ["Project Manager"] = new[] { Permissions.Projects.View, Permissions.Projects.Manage, Permissions.Inventory.View, Permissions.Inventory.Manage, Permissions.Construction.View, Permissions.Reports.View },
