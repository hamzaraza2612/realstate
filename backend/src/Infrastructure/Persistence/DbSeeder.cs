...
public static class DbSeeder
{
    private static readonly Dictionary<string, string[]> SystemRolePermissions = new()
    {
        ...
        ["Sales Manager"] = new[] { Permissions.Sales.BookingView, Permissions.Sales.BookingCreate, Permissions.Sales.BookingApprove, Permissions.Sales.BookingCancel, Permissions.Sales.PaymentRecord, Permissions.Crm.LeadView, Permissions.Crm.LeadCreate, Permissions.Crm.LeadUpdate, Permissions.Crm.LeadAssign, Permissions.Crm.CustomerView, Permissions.Crm.CustomerManage, Permissions.Reports.View },
        ["Sales Agent"] = new[] { Permissions.Crm.LeadView, Permissions.Crm.LeadCreate, Permissions.Crm.LeadUpdate, Permissions.Crm.CustomerView, Permissions.Sales.BookingView, Permissions.Sales.BookingCreate, Permissions.Sales.PaymentRecord },
