...
public static class DbSeeder
{
    private static readonly Dictionary<string, string[]> SystemRolePermissions = new()
    {
        ...
        ["Finance Manager"] = new[] { Permissions.Finance.InvoiceCreate, Permissions.Finance.PaymentApprove, Permissions.Finance.ReportsView, Permissions.Finance.Manage, Permissions.Sales.PaymentRecord, Permissions.AuditLogs.View, Permissions.Reports.View, Permissions.Documents.View, Permissions.Documents.Manage, Permissions.Approvals.View },
        ["Sales Manager"] = new[] { Permissions.Sales.BookingView, Permissions.Sales.BookingCreate, Permissions.Sales.BookingApprove, Permissions.Sales.BookingCancel, Permissions.Sales.PaymentRecord, Permissions.Crm.LeadView, Permissions.Crm.LeadCreate, Permissions.Crm.LeadUpdate, Permissions.Crm.LeadAssign, Permissions.Crm.LeadDelete, Permissions.Crm.CustomerView, Permissions.Crm.CustomerManage, Permissions.Crm.ActivityView, Permissions.Crm.ActivityManage, Permissions.Reports.View, Permissions.Documents.View, Permissions.Documents.Manage, Permissions.Approvals.View, Permissions.Portal.ManageAccounts },
        ["Sales Agent"] = new[] { Permissions.Crm.LeadView, Permissions.Crm.LeadCreate, Permissions.Crm.LeadUpdate, Permissions.Crm.CustomerView, Permissions.Crm.ActivityView, Permissions.Crm.ActivityManage, Permissions.Sales.BookingView, Permissions.Sales.BookingCreate, Permissions.Sales.PaymentRecord, Permissions.Documents.View },
        ["Project Manager"] = new[] { Permissions.Projects.View, Permissions.Projects.Manage, Permissions.Inventory.View, Permissions.Inventory.Manage, Permissions.Construction.View, Permissions.Reports.View, Permissions.Documents.View, Permissions.Documents.Manage, Permissions.Approvals.View },
        ["Construction Manager"] = new[] { Permissions.Construction.View, Permissions.Construction.ProjectManage, Permissions.Projects.View, Permissions.Procurement.View, Permissions.Procurement.RequestCreate, Permissions.Reports.View, Permissions.Documents.View, Permissions.Documents.Manage, Permissions.Approvals.View },
        ["Procurement Officer"] = new[] { Permissions.Procurement.View, Permissions.Procurement.RequestCreate, Permissions.Procurement.RequestApprove, Permissions.Procurement.OrderManage, Permissions.Procurement.OrderApprove, Permissions.Reports.View, Permissions.Documents.View, Permissions.Documents.Manage, Permissions.Approvals.View, Permissions.Portal.ManageAccounts },
        ["Property Manager"] = new[] { Permissions.Property.View, Permissions.Property.Manage, Permissions.Property.LeaseManage, Permissions.Property.LeaseApprove, Permissions.Property.PaymentRecord, Permissions.Property.MaintenanceManage, Permissions.Inventory.View, Permissions.Reports.View, Permissions.Documents.View, Permissions.Documents.Manage, Permissions.Approvals.View, Permissions.Portal.ManageAccounts },
        ["Facility Manager"] = new[] { Permissions.Facility.WorkOrderManage, Permissions.Facility.View, Permissions.Facility.Manage, Permissions.Facility.MallManage, Permissions.Facility.CoworkingManage, Permissions.Facility.PaymentRecord, Permissions.Property.MaintenanceManage, Permissions.Property.View, Permissions.Reports.View, Permissions.Documents.View, Permissions.Documents.Manage, Permissions.Portal.ManageAccounts },
        ["Accountant"] = new[] { Permissions.Finance.InvoiceCreate, Permissions.Finance.PaymentApprove, Permissions.Finance.ReportsView, Permissions.Finance.Manage, Permissions.Reports.View, Permissions.Documents.View, Permissions.Documents.Manage },
        ["HR Manager"] = new[] { Permissions.Hr.EmployeeManage, Permissions.Documents.View, Permissions.Documents.Manage },
