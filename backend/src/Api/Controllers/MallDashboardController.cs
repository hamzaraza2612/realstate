...
[Authorize]
[Route("api/v1/facility/mall/dashboard")]
public class MallDashboardController : ApiControllerBase
{
    private readonly IMallDashboardService _dashboardService;

    public MallDashboardController(IMallDashboardService dashboardService)
    {
